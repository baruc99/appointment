...
import { isNotAuthenticatedGuard } from './demo/components/auth/guards';
...
const routes: Routes = [
    { path: '', loadChildren: () => import('./demo/components/landing/landing.module').then(m => m.LandingModule) },
    {
        ...
        children: [
            ...
            { path: 'services', loadChildren: () => import('./demo/components/services/services.module').then( m => m.ServicesModule ) },
            { path: 'appointments', loadChildren: () => import('./demo/components/appointments/appointments.module').then( m => m.AppointmentsModule ) },
